<div class="container-fluid pad-t" style="padding:20px;">
	...
	?>
	<form action="<?php echo site_url('sudo/slider/tambah_proses'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
		<div class="form-group">
			<label class="control-label col-sm-2">Foto Slider</label>
			<div class="col-sm-4">
