<div class="container-fluid pad-t" style="padding:20px;">
	...
	if($this->input->get('balasan')==1){
		echo '<div class="alert alert-success">Berhasil mereset password</div>';
	}else if($this->input->get('balasan')==2){
		echo '<div class="alert alert-danger">Kata sandi tidak sama dengan ulangi kata sandi</div>';
	}
	?>
	<form action="<?php echo site_url('sudo/user/reset_password_proses/'.$query['id']); ?>" method="post" class="form-horizontal">
	<div class="form-group">
		...
		<div class="form-group">
			<label class="control-label col-sm-2">Ulangi Kata Sandi Baru</label>
			<div class="col-sm-4" style="margin-top:5px;">
				<input type="password" name="confirm_password" maxlength="20" class="form-control" placeholder="Ulangi Password" required>
			</div>
		</div>
		<div class="form-group">
